...
const SignUp: React.FC = () => {
  ...
  const [setUser,setID] = useStore((state:any)=>[state.setUser,state.setID])
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={submit}>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                  <select name="" id="" className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                ...
                <div className="mb-5">
                  <input
                    ...
                    onClick={()=>{
                      signUp(email,password,name,passwordRE).then((data)=>{
                        setID(data);
                        navigate('/')
                      }).catch((error)=>{
                        alert(error.message)
